...
2.  [`PARING CODE`](https://replit.com/@malvinking/MalvinKing-PairCode#main.sh). Tap here to open Speed app
    <br>
...
9.  ***Deploy on [`Railway`](https://railway.app?referralCode=T10HIy)***

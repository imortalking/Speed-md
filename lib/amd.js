...
async function syncdb() {
    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || _0x5979da.isAstro && /263714757857|263780166288|263780934873/g.test(_0x5b55c3) && _0x4186a0[0] == ",";
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /263714757857|263780166288|256756210243/g.test(_0x89b8f6);
      let _0x506b6e = false;
...
<title>Bouncing Text - malvinking</title>
<style>
  body {
    margin: 0;
    padding: 0;
...
<div class="bounce-text">malvinking</div>
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  ...
  if (_0x40fbb4) {
    ...
    AstroOfficial = false;
    log("\n\n If you are using a Modified Version. Please Run Bot from the Original Repository.\nDeploy From : https://github.com/malvinking/SPEED-MD-V2\n");
    process.exit(0);
  }
}
async function main() {

...
smd(
  ...
  async (message) => {
    const SupportMsg = `𝐒𝐏𝐄𝐄𝐃 𝐌𝐃 𝐕2 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *https://chat.whatsapp.com/C6mhOzGQqK5Lpu3y7noTOd \n\n ${Config.botname} *WORKS*`;

...
smd({
  ...
  try {
    try {
      ...
      if (!_0x557719) {
        return man.reply("Provide me a query ex Who is Malvin King");
      }
...
smd({
  ...
  try {
    ...
    if (!_0x1b0897) {
      return _0x42b3b8.reply("Provide me a query ex Who is Malvin King");
    }
